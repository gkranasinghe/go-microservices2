...
import (
	...
	"github.com/gkranasinghe/go-microservices/product-images/handlers"
...
func main() {
	...
	ph.HandleFunc("/images/{id:[0-9]+}/{filename:[a-zA-Z]+\\.png}", fh.ServeHTTP)

	// get files
	gh := sm.Methods(http.MethodGet).Subrouter()
	gh.Handle(
		"/images/{id:[0-9]+}/{filename:[a-zA-Z]+\\.png}",
