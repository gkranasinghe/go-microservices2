...
// New Local creates a Local filesystem with the given base path
...
// save the contents of the writer to given path
...
// the calling function is reponsible for closing the reader
